...
This program takes a text file with email addresses that are separated
by spaces and carriage returns.
It returns, to the screen, email addresses with semicolons after them.

Usage instructions: Put this file in a directory with a source text file.
Call the source file email.txt.
