...
def finder(content):
  ...
  for item in postbook:
    item0 = str(item[0])
    if d00.upper() == item0.upper():    # Test first letter of last name against the first character of first three letters of first key.
  ...
  for item in goodlist:
    ...
    if d10.upper() == item1.upper():    # Test second letter of last name against the second character of first three letters of first key.
